		...
		<div class="row" id="features">
			<div class="col-sm-4 feature">
				<div class="panel">
					...
					<img src="/resources/images/4.jpg" alt="VISIT THIS HOLY PLACE"
						class="img-circle">
			...
			<div class="col-sm-4 feature">
				<div class="panel">
					...
					<img src="/resources/images/6.jpg" alt="SWEET CHILDREN MEMORIES"
						class="img-circle">
			...
			<div class="col-sm-4 feature">
				<div class="panel">
					...
					<img src="/resources/images/5.jpg" alt="FAMILY VISIT"
						class="img-circle">
